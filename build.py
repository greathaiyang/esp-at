...
def install_prerequisites():
    ...
    if sys.platform == 'linux':
        cmd = 'sudo apt-get update && sudo apt-get install git wget flex bison gperf python3 python3-pip python3-venv python3-setuptools cmake ninja-build ccache libffi-dev libssl-dev dfu-util libusb-1.0-0'
